 ...
 *             &lt;pattern value="http://www.tim12.com/review_assignment/.+"/>
 *           &lt;/restriction>
 *         &lt;/simpleType>
 *       &lt;/attribute>
 *     &lt;/restriction>
...
public class TReviewAssignment {
    ...
    public TReviewAssignment(String title, TUser user, TBlinded blinded, String id) {
        this.sciencePaperTitle = title;
        this.reviewer = user;
